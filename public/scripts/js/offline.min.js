...
(function () {
    ...
    (d = function (a, b) {
      ...
      for (d in b.prototype)
        try {
          (f = b.prototype[d]),
            null == a[d] && 'function' != typeof f ? e.push((a[d] = f)) : e.push(void 0);
        } catch (g) {
          c = g;
        }
      return e;
      ...
      (a.markUp = function () {
        return (
          a.trigger('confirmed-up'), 'up' !== a.state ? ((a.state = 'up'), a.trigger('up')) : void 0
        );
      }),
      (a.markDown = function () {
        return (
      ...
      (a.checks.xhr = function () {
        ...
        (d = new XMLHttpRequest()),
          (d.offline = !1),
          d.open(a.getOption('checks.xhr.type'), a.getOption('checks.xhr.url'), !0),
          ...
          (e = function (b, c) {
            ...
            return (
              ...
              (b.open = function (e, f, g, h, i) {
                return (
                  a({ type: e, url: f, async: g, flags: c, user: h, password: i, xhr: b }),
                  d.apply(b, arguments)
                );
              })
            );
    ...
    function () {
      ...
      (d = Offline.reconnect = {}),
        ...
        (e = function () {
          var a;
          return (
            null != d.state && 'inactive' !== d.state && Offline.trigger('reconnect:stopped'),
            (d.state = 'inactive'),
            (d.remaining = d.delay =
        ...
        (h = function () {
          return 'waiting' === d.state
            ? (Offline.trigger('reconnect:connecting'), (d.state = 'connecting'), Offline.check())
            : void 0;
        }),
        (a = function () {
      ...
      (c = []),
        ...
        (d = function (a) {
          return Offline.getOption('requests') !== !1
            ? (Offline.trigger('requests:capture'), 'down' !== Offline.state && (f = !0), c.push(a))
            : void 0;
        }),
        (e = function (a) {
            ...
            for (Offline.trigger('requests:flush'), i = {}, d = 0, g = c.length; g > d; d++)
              (h = c[d]),
                ...
                Offline.getOption('deDupBody')
                  ? ((b = h.body),
                    (b = '[object Object]' === b.toString() ? JSON.stringify(b) : b.toString()),
                      ...
                      : ((b = g.onreadystatechange),
                        (g.onreadystatechange = function () {
                          return (
                            0 === g.readyState
                              ? f()
                              : 4 === g.readyState && (0 === g.status || g.status >= 12e3) && f(),
                            'function' == typeof b ? b.apply(null, arguments) : void 0
                          );
                        }))
                    : void 0
                );
        ...
        (j = function () {
          return (
            ...
            Offline.on('reconnect:success', function () {
              return (
                h('offline-ui-reconnect-succeeded-2s', 2), h('offline-ui-reconnect-succeeded-5s', 5)
              );
            })
          );
        }),
