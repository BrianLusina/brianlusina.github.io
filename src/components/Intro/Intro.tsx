...
const Intro: FunctionComponent = () => (
  <article id="intro">
    ...
    <p>
      ...
      egestas mauris. Ut magna finibus nisi nec lacinia. Nam maximus erat id euismod egestas. By the
    ...
    <p>
      ...
      In non lorem sit amet elit placerat maximus. Pellentesque aliquam maximus risus, vel sed
      vehicula.
    </p>
  </article>
);
